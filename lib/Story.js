...
const Cadaver = require('./Cadaver.js');
...
class Story {
  ...
  constructor(dataEl) {
     ...
     **/
     ...
     /**
       An object containing all Cadaver functionality.
       @property cadaver
       @type Cadaver
      **/

     this.cadaver = new Cadaver(p);
     ...
     **/
     ...
     for(let script of this.dataEl.children('*[type="text/twine-javascript"]') ) {
     ...
     **/
     ...
     for(let css of this.dataEl.children('*[type="text/twine-css"]') ) {
